...
const cardVariants = cva(
    "rounded-xl bg-background text-foreground transition duration-300 ease-in-out hover:drop-shadow-xl",
    {
        variants: {
            variant: {
                default: "flex flex-col w-96 shadow-lg cursor-pointer border border-primary/20 hover:border-primary/50",
                full: "flex flex-row items-center shadow-lg w-full border border-primary/20 hover:border-primary/50",
